...
function modal(data){
    var m = '<div id="reactsModal" class="reacts-container reacts-list-active"> ' +
...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        if( request.data !== null ) {
            ...
            document.getElementsByTagName("body")[0].innerHTML = modal(request.data) + document.getElementsByTagName('body')[0].innerHTML;
        }
    }
);
